<template>
    <div class="container">
        <div class="p-2 pageHeading">Pay Vendors (With POs)</div>
        <div class="row">
        ...
        <show-payments-per-vendor :form-type="formType" ref="showPaymentsPerVendor" :vendor-info="selectedItem" @reload:data="getAllVendorPayDetails" />
    </div>
</template>

<script>
    import axios from 'axios';
    import ShowPaymentsPerVendor from './ShowPaymentsPerVendor.vue';

    export default {
	    name:"ShowPoVendorPaymentDetails",
        components:{
            ShowPaymentsPerVendor
        },
        props:{
            formType: String
        },
        data(){
            return {
                loadingFailed: false,
                selectedItem:{},
                tableHeader: ['Vendor ID', 'Vendor Name', 'Vendor Phone', 'Amount Paid Till Date', 'Balance'],
                tableBody: [],
                invoices: [],
                loading: false,
                subTotal: 0,
        ...
        methods:{
            ...
            openItem(item) {
                ...
                this.$nextTick(()=>{
                    this.$refs.showPaymentsPerVendor.show();
                });
            },
        }
    }
