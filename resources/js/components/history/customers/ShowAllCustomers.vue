<template>
    <div class="container">
        ...
        <show-orders-per-customer ref="showOrdersPerCustomer" :customer-info="selectedItem" :form-type="formType" />
    </div>
</template>

<script>
    import axios from 'axios';
    import ShowOrdersPerCustomer from './ShowOrdersPerCustomer.vue';

    export default {
        name: "ShowAllCustomers",
        components: {
            ShowOrdersPerCustomer
        },
        props: ["formType"],
        data() {
            return {
        ...
        methods:{
            ...
            openItem(item) {
                ...
                this.$nextTick(()=>{
                    this.$refs.showOrdersPerCustomer.show();
                });
            },
        }
    }
