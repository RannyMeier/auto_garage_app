<template>
    <div v-if="showOrdersPerCustomer">
        <div id="modal">
...
export default {
    ...
    data() {
        return {
            showOrdersPerCustomer: false,
            currentDate: "",
            currentTime: "",
            tableHeader: ['Order ID', 'Order Date', 'Vehicle Model', 'Balance'],
            tableBody: [],
            distinctOrderIds: [],
            invoices: [],
            payDets: [],
    ...
    methods: {
        ...
        async show() {
            this.showOrdersPerCustomer = true;
            
            await this.getAllOrdersForGivenCustomer();
        },
        hide() {
            this.showOrdersPerCustomer = false;
        },
        openItem(item) {
