<template>
    <div v-if="displayEditCustomer">
        <div id="modal">
            <div class="modal-content">
                <div class="pageHeading">
                    View/Edit Customer<span class="closeModal pull-right" @click="hide">&times;</span>
                </div>
...
export default {
    ...
    computed:{
        disableUpdateButton() {
            return Object.entries(this.customerInfo).toString() === Object.entries(this.formFields).toString() || this.formFields.phone1 == '' || this.formFields.first_name == '' || this.formFields.last_name == '';
        },
    },
    methods:{
        acceptNumber(value) {
        ...
        async update(){
            ...
            try {
                axios.post(`updateGivenCustomer`, this.formFields);
            } catch (exception) {
        ...
        show() {
            this.formFields = JSON.parse(JSON.stringify(this.customerInfo));
